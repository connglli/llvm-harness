...
- Use `snake_case`.
- LLVM IR tools append `_ir` to indicate the input/output domain: `llvm_optimize_ir`, `llvm_verify_ir`, `llvm_compile_ir`, `llvm_execute_ir`, `llvm_interpret_ir`, `llvm_check_optim`, etc.
...
| Dependency | Tools |
|---|---|
| Always | `read`, `list`, `find`, `ripgrep`, `edit`, `write`, `bash`, `insight`, `smtsolve`, `llvm_optimize_ir`, `llvm_compile_ir`, `llvm_execute_ir`, `llvm_interpret_ir`, `llvm_check_optim` |
