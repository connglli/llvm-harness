...
- Use `snake_case`.
- LLVM IR tools append `_ir` to indicate the input/output domain: `llvm_optimize_ir`, `llvm_verify_ir`, `llvm_compile_ir`, `llvm_execute_ir`.
...
| build_dir | `llvm_optimize_ir`, `llvm_compile_ir`, `llvm_execute_ir` |
