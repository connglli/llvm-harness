...
class WriteTool(StatelessFuncToolBase):
  ...
  def spec(self) -> FuncToolSpec:
    return FuncToolSpec(
      "write",
      "Write content to a file, overwriting it entirely or creating it if it doesn't exist. "
      "Use this when you need to create a new file (e.g., a test case) or rewrite a file from scratch. "
      "Prefer to write temporary files into /tmp/. "
